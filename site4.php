        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link js-scroll-trigger" href="#quemSomos" >{{quemSomos}}</a>
              </li>
              <li class="nav-item">
...
<section class="container mt-5 ml-lg-5 forma2 forma3" id="espacinho">
  <div class="container mt-5 ml-lg-5">
    <div class="row g-0">
        <div class="col-lg-6">
          <h1 class="display-5 mt-5 ml-3" id="espaco">Nosso Espaço</h1>
        <p class="ml-4 mt-5">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit sapiente delectus dolores quaerat quibusdam quos alias praesentium tenetur ad ut, est laboriosam, similique nesciunt nulla, voluptatem libero expedita veritatis? Veniam!
            </p>
...
<section class="container forma mt-5">
  <form id="formu">
    <div class="form-row" >
      <div class="col">
        <input type="text" class="form-control form-control-lg mt-5 required" id="name" placeholder="Nome" >
        <input type="text" class="form-control form-control-lg mt-5 required" id="email" placeholder="E-mail">
        <input type="text" class="form-control form-control-lg mt-5 required" id="comment" placeholder="Telefone" >
...
var app = new Vue({
		el: '#app', '#contato',
		data:{
			quemSomos:'Eramos Nós',
			equipe: 'Equipe' ,
      espaço:  'Vambora Nobinho' ,
      faleConosco: 'Daniel Lixo'
